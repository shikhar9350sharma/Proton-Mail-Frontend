...
const SectionTen = () => {
    return (
        <div>
            <section className='w-full min-h-screen flex flex-col p-4 py-4 px-40'>
                <div className='my-10'><h2 className='text-3xl md:text-4xl font-serif text-[#372580]'>Proton Mail FAQ</h2></div>
                <div className='flex flex-col items-start space-y-5 '>
                    <div className='group w-full flex items-center justify-between py-4 border-b border-b-gray-300 hover:cursor-pointer'>
                        <div>
                ...
                <div className='flex flex-col items-start space-y-5 '>
                    <div className='group w-full flex items-center justify-between py-4 hover:cursor-pointer'>
                        <div>
